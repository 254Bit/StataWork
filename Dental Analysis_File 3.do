...
* Question 21 onwards: Mentorship (1) and Workshop (2)
* Provide oral health education to parents
tab   Provideoralhealtheducation if SN_end==1
tab   Provideoralhealtheducation if SN_end==2

* Examine the child's mouth
tab Examinethechildmouth_end if SN_end==1
tab Examinethechildmouth_base_ if SN_end==1

* Identify dental caries in children
tab Identifydentalcariesinchi if SN_end==1

* Identify gum diseases in children
tab GumDis_base_Pre if SN_end==1
tab GumDis_base_Post if SN_end==1
tab GumDis_end if SN_end==1

*Identify oral lesions in children
tab Identifyorallesionsinchil if SN_end==1

* Management of oral pain (emergency) in children
tab Managementoforalpainemer if SN_end==1

* Referral children for dental services
tab Referralchildrenfordental if SN_end==1

*Capture dental service in the daily activity register
tab Capturedentalserviceinthe if SN_end==1

* Report dental service/condition in the reporting tool
tab Reportdentalserviceconditi if SN_end==1

* Record child oral health information in the mother child booklet
tab Recordchildoralhealthinfo if SN_end==1
